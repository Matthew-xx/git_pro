...
*/
	...
	configname := "f:/Software/go_path/src/github.com/tedcy/fdfs_client/fdfs.conf"
	client,err:= fdfs_client.NewClientWithConfig(configname)
	if err != nil {
	...
	log.Println("文件上传成功：", fdfsresponse)
	defer f.Close()
	//返回文件ID
	return fdfsresponse
}
